...
const actors = [
  ...
  function introduceTheActors(actorArray){
    ...
    for(i = 0; i < actorArray.length; i++){
        intros = intros + "Hi I\'m " + actorArray[i].name + "and I was in" + actorArray[i].movie + "\n";
}
return intros;
  }
  ...
  function storeFounder(object1)
  {
      let array = [];
      for(const property in object)
      {
          array.splice(0,0,object[property]);
      }
      array.splice(0,1);
      return array;
  };
  ...
  pie.blueberry = funtion()
  {
      return "Delicious!"
  };
 
//not sure why this is showing that blueberry is not defined
  console.log(pie.blueberry());
